...
public class RunJets : MonoBehaviour
{
    ...
    // GeminiManager'dan bu fonksiyonu tetikleyeceğiz!
    public void SpeakFromAI(string aiText)
    {
        // Gelen metni JETS'e uygun hale getiriyoruz
        inputText = aiText;
        
        // Orijinal koddaki seslendirme fonksiyonunu başlatıyoruz
        TextToSpeech();
    }
